...
const defaultSkills: Omit<Skill, "id">[] = [
  ...
  { name: "Figma",        category: "Tools",    level: 85, icon: "https://cdn.simpleicons.org/figma/F24E1E",            icon_size: 70, order_index: 9  },
  ...
  { name: "Premiere",     category: "Creative", level: 70, icon: "https://cdn.simpleicons.org/adobepremierepro/9999FF", icon_size: 70, order_index: 14 },
];
